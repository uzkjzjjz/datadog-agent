...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.35.0-rc.7
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.35.0-rc.7
	github.com/DataDog/datadog-agent/pkg/quantile v0.35.0-rc.7
	github.com/DataDog/datadog-agent/pkg/security/secl v0.35.0-rc.7
	github.com/DataDog/datadog-agent/pkg/util/log v0.35.0-rc.7
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.35.0-rc.7
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.35.0-rc.7
