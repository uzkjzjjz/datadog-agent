...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.36.0-rc.5
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.36.0-rc.5
	github.com/DataDog/datadog-agent/pkg/quantile v0.36.0-rc.5
	github.com/DataDog/datadog-agent/pkg/remoteconfig/client v0.36.0-rc.5
	github.com/DataDog/datadog-agent/pkg/security/secl v0.36.0-rc.5
	github.com/DataDog/datadog-agent/pkg/trace v0.36.0-rc.5
	github.com/DataDog/datadog-agent/pkg/util/log v0.36.0-rc.5
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.36.0-rc.5
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.36.0-rc.5
