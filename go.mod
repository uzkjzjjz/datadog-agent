...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.37.0-rc.5
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.37.0-rc.5
	github.com/DataDog/datadog-agent/pkg/quantile v0.37.0-rc.5
	github.com/DataDog/datadog-agent/pkg/remoteconfig/client v0.37.0-rc.5
	github.com/DataDog/datadog-agent/pkg/security/secl v0.37.0-rc.5
	github.com/DataDog/datadog-agent/pkg/trace v0.37.0-rc.5
