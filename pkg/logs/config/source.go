...
// String provides a multi-line dump of the LogSource contents, for debugging purposes
func (s *LogSource) String() string {
	...
	fmt.Fprintf(&b, "\tConfig: %s,\n", strings.ReplaceAll(s.Config.String(), "\n", "\n\t"))
	fmt.Fprintf(&b, "\tStatus: %s,\n", strings.ReplaceAll(s.Status.String(), "\n", "\n\t"))
