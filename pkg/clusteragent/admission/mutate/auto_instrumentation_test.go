...
func TestInjectAutoInstruConfig(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expectedEnvVal: " --require=/autoinstrumentation/node_modules/dd-trace/init",
			wantErr:        false,
		},
		{
			...
			image:          "gcr.io/datadoghq/dd-lib-js-init:v1",
			expectedEnvKey: "NODE_OPTIONS",
			expectedEnvVal: "predefined --require=/autoinstrumentation/node_modules/dd-trace/init",
			wantErr:        false,
		},
		{
			...
			expectedEnvVal: "/autoinstrumentation/:/autoinstrumentation",
			wantErr:        false,
		},
		{
			...
			image:          "gcr.io/datadoghq/dd-lib-python-init:v1",
			expectedEnvKey: "PYTHONPATH",
			expectedEnvVal: "/autoinstrumentation/:predefined:/autoinstrumentation",
			wantErr:        false,
		},
	}
