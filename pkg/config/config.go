...
func InitConfig(config Config) {
	...
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.rate_exec", 100)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.burst_exec", 200)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.rate_open", 50)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.burst_open", 100)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.rate_dns", 10)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.burst_dns", 20)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.rate_bind", 10)
	config.BindEnvAndSetDefault("runtime_security_config.activity_dump.burst_bind", 20)
