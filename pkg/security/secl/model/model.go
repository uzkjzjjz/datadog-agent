...
//go:generate go run github.com/DataDog/datadog-agent/pkg/security/secl/compiler/generators/accessors -accessors -output . -mock
//go:generate go run github.com/DataDog/datadog-agent/pkg/security/secl/compiler/generators/accessors -tags linux -output ../../probe/ -doc ../../../../docs/cloud-workload-security/secl.json -fields-resolver
