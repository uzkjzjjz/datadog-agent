...
func easyjsonF642ad3eDecodeGithubComDataDogDatadogAgentPkgSecurityModule(in *jlexer.Lexer, out *BackendEvent) {
...
func easyjsonF642ad3eEncodeGithubComDataDogDatadogAgentPkgSecurityModule(out *jwriter.Writer, in BackendEvent) {
	out.RawByte('{')
	first := true
	_ = first
	{
