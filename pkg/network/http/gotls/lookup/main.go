...
//go:generate go run -tags linux_bpf ./internal/generate_luts.go --test-program ./internal/program.go --package lookup --out ./luts.go --min-go 1.13 --arch amd64,arm64 --shared-build-dir /var/tmp/datadog-agent/system-probe/go-toolchains
